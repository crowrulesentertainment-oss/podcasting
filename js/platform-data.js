...
window.CrowRulesData={ready:boot(),getClient:()=>db,getClientAsync,getAccessToken,getState:()=>structuredClone(state),getUser,requireAuth,query,subscribe,refresh,signOut,on:fn=>{listeners.add(fn);return()=>listeners.delete(fn)}};
