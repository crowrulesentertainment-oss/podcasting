...
function nav(){
 ...
 if(el.dataset.navReady==="true")return; el.dataset.navReady="true";
 el.innerHTML=`<header class="nav" role="banner"><a class="wordmark" href="home.html" aria-label="CrowRules Podcasting home">CROWRULES<span>/ PODCASTING</span></a><button class="nav-toggle" type="button" aria-expanded="false" aria-controls="crPrimaryNav">MENU</button><nav id="crPrimaryNav" aria-label="Primary navigation"><a href="home.html">Home</a><a href="discover.html">Discover</a><a href="charts.html">Charts</a><a href="live.html">Live</a><a href="schedule.html">Schedule</a><a href="library.html">Library</a><a href="studio.html">Studio</a></nav><div class="nav-actions"><a href="search.html" class="nav-icon" aria-label="Search">⌕</a><a href="notifications.html" class="points-pill" aria-label="Notifications">🔔 <b id="notificationCount"></b></a><a href="crowpoints.html" class="points-pill" aria-label="CrowPoints">◉ <b>${state.points}</b></a><a href="account.html" class="avatar" id="accountAvatar" aria-label="Account">CR</a></div></header><div class="network-bar" aria-label="Podcasting network navigation"><div class="network-links"><a href="creators.html">Creators</a><a href="subscriptions.html">Subscriptions</a><a href="distribution.html">RSS & Distribution</a><a href="creator-dashboard.html">Creator OS</a><a href="analytics.html">Analytics</a><a href="growth.html">Growth</a><a href="live-production.html">Live Studio</a><a href="live-command.html">Live Command</a><a href="live-replays.html">Replays</a><a href="subscribers.html">Subscribers</a><a href="earnings.html">Earnings</a><a href="payouts.html">Payouts</a><a href="admin.html">Admin</a><a href="help.html">Help</a></div></div>`;
 const toggle=el.querySelector(".nav-toggle"),navEl=el.querySelector("#crPrimaryNav"); toggle?.addEventListener("click",()=>{const open=toggle.getAttribute("aria-expanded")==="true";toggle.setAttribute("aria-expanded",String(!open));navEl?.classList.toggle("open",!open)}); window.addEventListener("scroll",()=>document.querySelector(".nav")?.classList.toggle("scrolled",scrollY>12),{passive:true});
}
