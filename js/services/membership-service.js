...
window.CrowRulesMembership={version:"2.0",user:contract(user),subscriptions:contract(subscriptions),current:contract(current),plans:contract(plans),podcastSubscriptions:contract(podcastSubscriptions),entitlement:contract(entitlement)};
})();