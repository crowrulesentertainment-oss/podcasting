...
const base=()=>window.CROW_CONFIG?.supabaseUrl||window.CROWRULES_SUPABASE_URL;
const key=()=>window.CROW_CONFIG?.supabaseKey||window.CROWRULES_SUPABASE_PUBLISHABLE_KEY;
